...
<main>
    <div class="container-fluid px-4">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form id="supplier-form" action="add-supplier" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="supplier_telepon" name="supplier_telepon" value="<?=old('supplier_telepon')?>">
                            <div class="invalid-feedback">
                                <!-- Validation error message -->
                            </div>
                        </div>
